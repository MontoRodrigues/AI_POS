...
import { PosExternalScanner1 } from './components/pos-external-scanner1/pos-external-scanner1';
...
export const routes: Routes = [
    ...
    { path: 'posScanner', component: PosExternalScanner1, canActivate: [AuthGuard] },
